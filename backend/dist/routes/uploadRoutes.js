...
const processReceiptUploadController_1 = require("../controllers/processReceiptUploadController");
const router = express_1.default.Router();
router.post("/upload", checkAuth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.file) {
        return res.status(400).json({ message: "No file uploaded" });
    }
    try {
        // Forward the file to the controller for processing
        yield (0, processReceiptUploadController_1.processReceiptUploadController)(req.file, req.body.uid, res);
